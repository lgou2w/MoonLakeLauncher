...
class MuiRightTransition(contentHolder: Node, pane: Pane, offsetX: Double, cycleDuration: Duration = Duration.seconds(.4), delay: Duration = Duration.seconds(.0)): MuiDirectionTransition(Direction.Type.RIGHT, contentHolder, Timeline(
